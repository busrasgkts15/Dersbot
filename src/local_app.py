...
# EĞER PROJEYİ LOCALDE ÇALIŞTIRMAK İSTİYORSANIZ BU DOSYAYI ÇALIŞTIRIN.
# app.py dosyasından tek farkı dosya yoludur streamlit platformu ../ şeklinde yer alan dizine hata vermektedir.
